...
urlpatterns = [
    ...
    path('plots/<slug:slug>/request-deallotment/<str:plot_number>/', views.request_deallotment, name='request_deallotment'),
    path('plots-creator/<slug:slug>/decide-deallotment/<int:request_id>/', views.decide_deallotment, name='decide_deallotment'),
