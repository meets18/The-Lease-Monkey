"""
Django settings for leasemonkey project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.accounts.context_processors.nav_notifications',
            ],
        },
    },
]

WSGI_APPLICATION = 'leasemonkey.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'leasemonkey'),
...
AUTHENTICATION_BACKENDS = [
    ...
    'apps.accounts.backends.MultiBackend',
]
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'The Lease Monkey <noreply@leasemonkey.com>')

# Known accounts for dev-phase notification routing
